...
public class ppayment_price extends HttpServlet {    
    protected void doPost(HttpServletRequest req, HttpServletResponse res)
        ...
        String price=req.getParameter("t4");
        String l_date=req.getParameter("t5");
        ...
        try 
        {
          ...
          String q2="Select * from phar_pay where status='Not_paid'";
...
"                 </table>\n" + 
          ...
          else
          {
            ...
            String q1="insert into phar_pay values('"+name+"','"+email+"','"+price+"','"+l_date+"','"+status+"')";
...
"                 </table>\n" + 
                      "<div class=\"log\"> "+
                      "<b>Payment amount generate Successfully.</b>"+
                      "</div>"+
                  "</body>\n");
            }
            else
